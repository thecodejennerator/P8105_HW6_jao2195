...
**Problem 1A** <br> **1aQ** Create a city_state variable
...
**Problem 1B** <br> **1bQ** For the city of Baltimore, MD, use the glm
function to fit a logistic regression with resolved vs unresolved as the
outcome and victim age, sex and race as predictors. Save the output of
glm as an R object; apply the broom::tidy to this object; and obtain the
...
**Problem 1C** <br> **1cQ** Now run glm for each of the cities in your
dataset, and extract the adjusted odds ratio (and CI) for solving
homicides comparing male victims to female victims. Do this within a
“tidy” pipeline, making use of purrr::map, list columns, and unnest as
...
**Problem 1D** <br> **1dQ** <br> Create a plot that shows the estimated
ORs and CIs for each city. Organize cities according to estimated OR,
...
![](P8105_HW6_jao2195_files/figure-gfm/unnamed-chunk-11-2.png)<!-- -->
...
![](P8105_HW6_jao2195_files/figure-gfm/unnamed-chunk-11-3.png)<!-- -->
...
![](P8105_HW6_jao2195_files/figure-gfm/unnamed-chunk-11-4.png)<!-- -->
